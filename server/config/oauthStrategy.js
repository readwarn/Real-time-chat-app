...
passport.use(
  new GoogleStrategy(
    {
      clientID:
        "766284901009-addbg5mgubtrnv5doie939saihjsr530.apps.googleusercontent.com",
      clientSecret: "LhNiJw8ZqbyWw64-Fzkdyt1i",
      callbackURL:
        "https://whispering-everglades-42925.herokuapp.com/auth/google/redirect",
    },
  ...
  new GitHubStrategy(
    {
      ...
      callbackURL:
        "https://whispering-everglades-42925.herokuapp.com/auth/github/redirect",
    },
    function (accessToken, refreshToken, profile, done) {
      UserServices.findOrCreate(UserServices.User, done, profile);
    }
  ...
  new FacebookStrategy(
    {
      ...
      callbackURL:
        "https://whispering-everglades-42925.herokuapp.com/auth/facebook/redirect",
    },
    function (accessToken, refreshToken, profile, done) {
      UserServices.findOrCreate(UserServices.User, done, profile);
    }
